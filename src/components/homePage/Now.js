...
const Now = () => (
  <section id="now" className="now-section section-space">
    <div className="container now-layout">
      <div>
        <p className="eyebrow">Active research / systems note</p>
        <h2>How can AI make engineering teams more capable, not merely faster?</h2>
      </div>
      <div className="now-content">
        ...
        <p className="now-note">Research objective: make reliable engineering practices easier to follow by default.</p>
      </div>
    </div>
  </section>
);
